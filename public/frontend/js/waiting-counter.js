function countdown(targetDate) {
    ...
    var x = setInterval(function() {
      ...
      if (distance < 0) {
        ...
        m.innerHTML = "০০";
        s.innerHTML = "০০";
        // Refresh the current page when times up
  ...
  // Usage: Set the desired target date and time for the countdown
  var targetDate = new Date("July 28, 2023 17:00:00").getTime();
