...
<body>
    ...
    <section class="bg cover lg:h-[800px] ">
        ...
        <div class="flex justify-center items-center flex-col">
            <h1 class="text-center xl:text-[38px] md:text-[30px] sm:text-[25px]">কনসার্ট নিবন্ধন বর্তমানে বন্ধ আছে.</h1><br>
            <div class="title_text xl:text-[35px] md:text-[30px] sm:text-[20px]">
